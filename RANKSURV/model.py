...
class CombinedLossSurvModel(torch.nn.Module):
    ...
    def forward(self, x, event_time, event_indicator):
        ...
        mask = event_time < max(event_time)-2
        event_time1 = event_time[mask]
        event_indicator1 = event_indicator[mask]
        estimate1 = estimate[mask]
        
        cindex = -1 * self.cindex_loss(event_indicator1, event_time1, estimate1)
